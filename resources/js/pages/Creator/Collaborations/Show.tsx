    ...
    return (
        <>
            ...
            <CollaborationWorkspaceLayout
                ...
                tabs={[
                    { value: 'messages', label: 'Pesan', count: collaboration.messages.length },
                    { value: 'progress', label: 'Progres', count: collaboration.progress.length },
                    { value: 'content', label: 'Submission', count: collaboration.submissions.length },
                    { value: 'review', label: 'Review', count: collaboration.reviews.length },
                ]}
                activeTab={tab}
                onTabChange={setTab}
            >
                ...
                {tab === 'progress' ? (
                        <SectionPanel
                            title="Progres"
                            description="Update progres kolaborasi dari Anda."
                        >
                            <div className="space-y-3">
                ...
                {tab === 'content' ? (
                        <SectionPanel
                            title="Submission"
                            description="Versi konten yang Anda kirimkan."
                        >
                            <div className="space-y-3">
